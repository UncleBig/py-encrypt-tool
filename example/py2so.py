...
if __name__ == "__main__":
    ...
    try:
        ...
        print(module_list)
        # specify python3 source in Cython : compiler_directives={'language_level' : "3"}
        setup(ext_modules=cythonize(module_list, compiler_directives={'language_level': "3"}),
              script_args=["build_ext", "-b", build_dir, "-t", build_tmp_dir])
        module_list = list(getpy(basepath=currdir, parentpath=parentpath, build_dir=build_dir,
